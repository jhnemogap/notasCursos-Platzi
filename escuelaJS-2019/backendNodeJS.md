...
![nodejs-logo](./img-md/backendNodeJS_nodejs-logo.svg)
...
- [Curso de Backend con Node.js](#curso-de-backend-con-nodejs)
  - [**_Escuela de JavaScript - Platzi 2019_**](#escuela-de-javascript---platzi-2019)
  - [Tabla de contenido](#tabla-de-contenido)
  - [Qué es Node.js y para que sirve](#qu%c3%a9-es-nodejs-y-para-que-sirve)
  ...
  - [Instalación de Node.js](#instalaci%c3%b3n-de-nodejs)
  ...
  - [Exploremos los métodos más comunes](#exploremos-los-m%c3%a9todos-m%c3%a1s-comunes)
    - [Response end()](#response-end)
    - [Response json()](#response-json)
    - [Response send()](#response-send)
  - [¿Qué es express y para que sirve?](#%c2%bfqu%c3%a9-es-express-y-para-que-sirve)
  - [Crea tu primer servidor en express](#crea-tu-primer-servidor-en-express)
  - [Anatomía de una API Restful](#anatom%c3%ada-de-una-api-restful)
  - [Estructura de una película con Mockaroo](#estructura-de-una-pel%c3%adcula-con-mockaroo)
  - [Implementando un CRUD en express.js](#implementando-un-crud-en-expressjs)
    - [Métodos idempotentes del CRUD](#m%c3%a9todos-idempotentes-del-crud)
  - [Implementando una capa de servicios en express](#implementando-una-capa-de-servicios-en-express)
  - [Creación de una BD en MongoAtlas](#creaci%c3%b3n-de-una-bd-en-mongoatlas)
  - [Conexión a MongoAtlas una instancia de MongoDB](#conexi%c3%b3n-a-mongoatlas-una-instancia-de-mongodb)
  - [Implementación de las acciones de MongoDB](#implementaci%c3%b3n-de-las-acciones-de-mongodb)
  - [Conexión de nuestros servicios con MongoDB](#conexi%c3%b3n-de-nuestros-servicios-con-mongodb)
  - [¿Qué es un middleware?](#%c2%bfqu%c3%a9-es-un-middleware)
  - [Manejador de erroes asíncronos y síncronos en Express](#manejador-de-erroes-as%c3%adncronos-y-s%c3%adncronos-en-express)
  - [Capa de validación de datos a travéz de un middleware](#capa-de-validaci%c3%b3n-de-datos-a-trav%c3%a9z-de-un-middleware)
  - [¿Qué es Join y Boom?](#%c2%bfqu%c3%a9-es-join-y-boom)
  ...
  - [## Tests](#tests)
  - [Creación de test para nuestros endpoints](#creaci%c3%b3n-de-test-para-nuestros-endpoints)
  - [Creación de Test para nuestros servicios](#creaci%c3%b3n-de-test-para-nuestros-servicios)
  - [Creación de Test para nuestras utilidades](#creaci%c3%b3n-de-test-para-nuestras-utilidades)
  - [Agregando un comando coverage](#agregando-un-comando-coverage)
  - [Considerenado las mejores prácticas para el despliegue](#considerenado-las-mejores-pr%c3%a1cticas-para-el-despliegue)
  - [Variables de entorno, CORS y HTTPS](#variables-de-entorno-cors-y-https)
    ...
    - [¿Cuando no es posible acceder al servidor remoto?](#%c2%bfcuando-no-es-posible-acceder-al-servidor-remoto)
    - [Variables de entorno de forma nativa](#variables-de-entorno-de-forma-nativa)
    - [Habilitando CORS en producción](#habilitando-cors-en-producci%c3%b3n)
    - [Habilitar CORS para todos los request (No recomendado en producción)](#habilitar-cors-para-todos-los-request-no-recomendado-en-producci%c3%b3n)
    - [Habilitar CORS para los request específicos de un cliente (Recomendado para producción)](#habilitar-cors-para-los-request-espec%c3%adficos-de-un-cliente-recomendado-para-producci%c3%b3n)
    - [Cómo funciona y por qué es importante el uso de HTTPS](#c%c3%b3mo-funciona-y-por-qu%c3%a9-es-importante-el-uso-de-https)
    - [Por qué usar HTTPS](#por-qu%c3%a9-usar-https)
    - [Cómo funciona](#c%c3%b3mo-funciona)
    - [Cómo habilitar HTTPS en nuestro servidor](#c%c3%b3mo-habilitar-https-en-nuestro-servidor)
  - [Como implementar una capa de manejo de caché en express](#como-implementar-una-capa-de-manejo-de-cach%c3%a9-en-express)
  - [¿Cómo contener tu aplicación en Docker?](#%c2%bfc%c3%b3mo-contener-tu-aplicaci%c3%b3n-en-docker)
...
**El entorno de ejecución:** es la capa que corre por el sistema operativo que ejecuta software, básicamente se encarga de como se consume memoria, como acceder a las variables y como corre el [garbage collector](https://es.wikipedia.org/wiki/Recolector_de_basura).

[Chrome V8](https://es.wikipedia.org/wiki/Chrome_V8) Es un engine de Javascript por de **chromiund-project** para chrome y chromium. Además de chrome existen **2 proyectos** que son **chromium** que es la versión open source y luego **chrome canary**, chrome canary se llamá así por una analogía donde antiguamente los mineros iban a la mina y para detectar si había gases o algún peligro, ponían a un canario en una pequeña jaula, si había un gas y pasaba algo, el canario lastimosamente moría y es la manera en como se daban cuenta si había algún error, lo mismo pasa con chrome canary, es la manera como detectan errores y si todo sale bien, lo pasan a chrome.
...
<div align="center">
  <img src="./img-md/backendNodeJS_mockaroo.jpg" alt="mockaroo estrucutura">
</div>
...
<div align="center">
  <img src="./img-md/backendNodeJS_mockaroo-preview.jpg" alt="mockaroo estrucutura">
</div>
<br>
<div align="right">
  <small><a href="#tabla-de-contenido">🡡 volver al inicio</a></small>
...
<div align="center">
  <img src="./img-md/backendNodeJS_routes.png" alt="rutas">
</div>
...
_[Volver al inicio](#tabla-de-contenido)_
...
<div align="center">
  <img src="./img-md/backendNodeJS_clean-arquitect.png" alt="clean arquitect">
</div>
<br>
...
<div align="center">
  <img src="./img-md/backendNodeJS_uri-mongo.png" alt="uri-mongo">
</div>
<br>
...
<div align="center">
  <img src="./img-md/backendNodeJS_mongodb.png" alt="crud mongo">
</div>
<br>
...
<div align="center">
 <img src="./img-md/backendNodeJS_middleware.png" alt="middleware">
</div>
...
<div align="center">
  <img src="./img-md/backendNodeJS_validationHandler.png" alt="validationHandler">
</div>
<br>
<div align="right">
  <small><a href="#tabla-de-contenido">🡡 volver al inicio</a></small>
